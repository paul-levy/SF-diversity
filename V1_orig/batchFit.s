...
#SBATCH --job-name=cBasinFlatSpOpt

#SBATCH --mail-user=pl1465@nyu.edu
#SBATCH --mail-type=ALL

#SBATCH --output=spOptBasin_%A_%a.out
#SBATCH --error=spOptBasin_%A_%a.err
...
python model_responses.py $SLURM_ARRAY_TASK_ID 1e-5 0.1 4 1 1 0
