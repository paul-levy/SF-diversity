...
do
  ...
  ## LGN - descrFits (DoG)
  #python descr_fits.py $run 0 LGN/ 0 0 0 0 1 1 2 1 &
  #python descr_fits.py $run 1 LGN/ 0 0 0 0 1 1 2 1 &
  #python descr_fits.py $run 2 LGN/ 0 0 0 0 1 1 2 1 &
  #python descr_fits.py $run 3 LGN/ 0 0 0 0 1 1 2 1 &
  ...
  python descr_fits.py $run 0 V1/ 0 1 0 2 0 0 3 1 & # without phAdv fits
  python descr_fits.py $run 1 V1/ 0 1 0 2 0 0 3 1 &
  python descr_fits.py $run 2 V1/ 0 1 0 2 0 0 3 1 &
  python descr_fits.py $run 3 V1/ 0 1 0 2 0 0 3 1 &

  # V1 - descr fits
  #python descr_fits.py $run 0 V1/ 0 0 0 1 1 0 2 1 & 
  #python descr_fits.py $run 0 V1/ 0 0 0 1 1 0 3 1 & 
