...
def SFMSimpleResp(ph_stimOr, ph_stimTf, ph_stimCo, ph_stimSf, ph_stimPh, mod_params):   
    ...
    # Compute spatial frequency tuning - will be nGratings[7] x nTrials
    ...
    # Compute temporal frequency tuning - will be nGratings[7] x nTrials
    ...
    # Therefore...size is 120 x nGratings[7] x nTrials
...
def setModel(cellNum, fitIter, lr, subset_frac = 0, initFromCurr = 1):
    ...
    loc_data = '/Users/paulgerald/work/sfDiversity/sfDiv-OriModel/sfDiv-python/altExp/analysis/structures/'; # personal machine
