...
#fitBase = 'fitList%s_pyt_nr221106d_noRE_noSched%s' % (loc_str, '_sg' if singleGratsOnly else '')
fitBase = 'fitList%s_pyt_nr221106d_noSched%s' % (loc_str, '_sg' if singleGratsOnly else '')
