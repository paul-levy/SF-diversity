...
do
  ...
  # pytorch mod, poiss loss; modA: flat, fixed RVC, lgn A; modB: wght, fixed RVC, lgnA
  python3.6 plot_diagnose_vLGN.py $run 2 2 V1/ 12 22 11 -1 1 0 0 0.05 -1 1 1 & # no diff, not interpolated
