...
for run in {1..8}
do
  python3.6 plot_diagnose_vLGN.py $run 2 4 V1/ 1 1 1 0 0 0.05 1 1 & # no diff, not interpolated
  python3.6 plot_diagnose_vLGN.py $run 2 4 V1_orig/ 1 1 1 0 0 0.05 1 1 & # no diff, not interpolated
  python3.6 plot_diagnose_vLGN.py $run 2 4 altExp/ 1 1 1 0 0 0.05 1 1 & # no diff, not interpolated

  python3.6 plot_diagnose_vLGN.py $run 2 4 V1/ 2 1 1 0 0 0.05 1 1 & # no diff, not interpolated
  python3.6 plot_diagnose_vLGN.py $run 2 4 V1_orig/ 2 1 1 0 0 0.05 1 1 & # no diff, not interpolated
  python3.6 plot_diagnose_vLGN.py $run 2 4 altExp/ 2 1 1 0 0 0.05 1 1 & # no diff, not interpolated
